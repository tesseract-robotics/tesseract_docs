...
\DoxyCodeLine{127     \mbox{\hyperlink{namespacetesseract__collision_a1e54919ee87e54445b7926d0b2880882}{flattenMoveResults}}(std::move(result), result\_vector[\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(tn)]);}
\DoxyCodeLine{128   \}}
...
\DoxyCodeLine{134   \{}
\DoxyCodeLine{135     \mbox{\hyperlink{collision__core__unit_8cpp_afe63203c82f4c445980c6e005d380ad7}{EXPECT\_TRUE}}(result\_vector[\textcolor{keyword}{static\_cast<}std::size\_t\textcolor{keyword}{>}(i)].size() == 2700);}
\DoxyCodeLine{136   \}}
\DoxyCodeLine{137 \}}
